...
app.controller('addController',function($scope,$firebaseArray,$state,recipeService){
...
app.controller('groupController', function($scope, $firebaseArray, $state, groupService){
  $scope.groups = groupService.all;

});

app.controller('listController', function($scope,recipeService) {
  $scope.recipes = recipeService.all;
})

app.controller('recipeController',function($scope,recipeService,$stateParams,$state){
